  ...
  secciones: [
    ...
    },
    {
      ...
      p: [
        ...
        'Dentro de cada panel, los totales van separados por moneda —ARS, USD y el combinado— y distinguen el líquido (la plata que destinaste y todavía no invertiste) del invertido (lo que ya está en activos). El líquido aparece en la fila ARS y en la combinada, con el mismo número: tus aportes son en pesos, y lo que compraste en dólares lo pagaste con esos pesos, así que lo que queda sin invertir está en pesos. En la fila USD va un guión. La columna Variación compara lo invertido contra lo que vale hoy.',
