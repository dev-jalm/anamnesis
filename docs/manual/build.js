  ...
  secciones: [
    ...
    },
    {
      ...
      lista: [
        ...
        'La cabecera de cada panel repite la concentración, separada por moneda: la barra de la fila ARS reparte por sector lo que tenés en pesos, y la de la fila USD lo que tenés en dólares, con los mismos colores. Esas barras no incluyen el Líquido —la cabecera lo muestra en su propia columna—, así que sus porcentajes pueden no coincidir con los del gráfico de abajo, que sí lo cuenta. Pasando el mouse por un tramo —o por una fila del gráfico de abajo— se ven dos líneas: el sector con su porcentaje y su monto, y debajo cada activo con su porcentaje, que sumados dan el del sector.',
