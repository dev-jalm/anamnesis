  ...
  secciones: [
    ...
    },
    {
      ...
      p: [
        ...
        'Dentro de cada panel, los totales van separados por moneda —ARS, USD y el combinado— y distinguen el líquido (la plata que destinaste y todavía no invertiste) del invertido (lo que ya está en activos). El líquido figura en la fila ARS y en la combinada: tus aportes son en pesos, así que lo que queda sin invertir también. La columna Variación compara lo invertido contra lo que vale hoy.',
