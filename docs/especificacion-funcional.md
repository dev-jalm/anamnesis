...
| RF-073y | Cada tabla se encabeza con su rótulo —"Activos comprados en" seguido de la moneda, en mayúsculas y con el mismo tratamiento que los rótulos de los gráficos de Concentración (RF-072g)—, a continuación la cantidad de tickers y, por último, el acceso a actualizar precios |
...
| 1.38 | 20/09/2026 | Cada tabla se encabeza con "Activos comprados en" y su moneda (RF-073y), y las filas de Liquidado toman el alto de las de Activos (RF-072b) | **Vigente** |
